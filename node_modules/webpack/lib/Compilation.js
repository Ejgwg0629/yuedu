...
class Compilation extends Tapable {
	...
	constructor(compiler) {
		...
		this.hooks = {
			...
			buildModule: new SyncHook(["module"], "compilation.buildModule"),
			/** @type {SyncHook<Module>} */
			rebuildModule: new SyncHook(["module"], "compilation.rebuildModule"),
			/** @type {SyncHook<Module, Error>} */
			failedModule: new SyncHook(["module", "error"], "compilation.failedModule"),
			/** @type {SyncHook<Module>} */
			succeedModule: new SyncHook(["module"], "compilation.succeedModule"),

			/** @type {SyncHook<Dependency, string>} */
			addEntry: new SyncHook(["entry", "name"], "compilation.addEntry"),
			/** @type {SyncHook<Dependency, string, Error>} */
			failedEntry: new SyncHook(["entry", "name", "error"], "compilation.failedEntry"),
			/** @type {SyncHook<Dependency, string, Module>} */
			succeedEntry: new SyncHook(["entry", "name", "module"], "compilation.succeedEntry"),
			...
			finishModules: new AsyncSeriesHook(["modules"], "compilation.finishModules"),
			/** @type {SyncHook<Module>} */
			finishRebuildingModule: new SyncHook(["module"], "compilation.finishRebuildingModule"),
			/** @type {SyncHook} */
			unseal: new SyncHook([], "compilation.unseal"),
			/** @type {SyncHook} */
			seal: new SyncHook([], "compilation.seal"),

			/** @type {SyncHook} */
			beforeChunks: new SyncHook([], "compilation.beforeChunks"),
			/** @type {SyncHook<Chunk[]>} */
			afterChunks: new SyncHook(["chunks"], "compilation.afterChunks"),

			/** @type {SyncBailHook<Module[]>} */
			optimizeDependenciesBasic: new SyncBailHook(["modules"], "compilation.optimizeDependenciesBasic"),
			/** @type {SyncBailHook<Module[]>} */
			optimizeDependencies: new SyncBailHook(["modules"], "compilation.optimizeDependencies"),
			/** @type {SyncBailHook<Module[]>} */
			optimizeDependenciesAdvanced: new SyncBailHook(["modules"], "compilation.optimizeDependenciesAdvanced"),
			/** @type {SyncBailHook<Module[]>} */
			afterOptimizeDependencies: new SyncHook(["modules"], "compilation.afterOptimizeDependencies"),

			/** @type {SyncHook} */
			optimize: new SyncHook([], "compilation.optimize"),
			/** @type {SyncBailHook<Module[]>} */
			optimizeModulesBasic: new SyncBailHook(["modules"], "compilation.optimizeModulesBasic"),
			/** @type {SyncBailHook<Module[]>} */
			optimizeModules: new SyncBailHook(["modules"], "compilation.optimizeModules"),
			/** @type {SyncBailHook<Module[]>} */
			optimizeModulesAdvanced: new SyncBailHook(["modules"], "compilation.optimizeModulesAdvanced"),
			/** @type {SyncHook<Module[]>} */
			afterOptimizeModules: new SyncHook(["modules"], "compilation.afterOptimizeModules"),

			/** @type {SyncBailHook<Chunk[], ChunkGroup[]>} */
			optimizeChunksBasic: new SyncBailHook(["chunks", "chunkGroups"], "compilation.optimizeChunksBasic"),
			/** @type {SyncBailHook<Chunk[], ChunkGroup[]>} */
			optimizeChunks: new SyncBailHook(["chunks", "chunkGroups"], "compilation.optimizeChunks"),
			/** @type {SyncBailHook<Chunk[], ChunkGroup[]>} */
			optimizeChunksAdvanced: new SyncBailHook(["chunks", "chunkGroups"], "compilation.optimizeChunksAdvanced"),
			/** @type {SyncHook<Chunk[], ChunkGroup[]>} */
			afterOptimizeChunks: new SyncHook(["chunks", "chunkGroups"], "compilation.afterOptimizeChunks"),

			/** @type {AsyncSeriesHook<Chunk[], Module[]>} */
			optimizeTree: new AsyncSeriesHook(["chunks", "modules"], "compilation.optimizeTree"),
			/** @type {SyncHook<Chunk[], Module[]>} */
			afterOptimizeTree: new SyncHook(["chunks", "modules"], "compilation.afterOptimizeTree"),

			/** @type {SyncBailHook<Chunk[], Module[]>} */
			optimizeChunkModulesBasic: new SyncBailHook(["chunks", "modules"], "compilation.optimizeChunkModulesBasic"),
			/** @type {SyncBailHook<Chunk[], Module[]>} */
			optimizeChunkModules: new SyncBailHook(["chunks", "modules"], "compilation.optimizeChunkModules"),
			/** @type {SyncBailHook<Chunk[], Module[]>} */
			optimizeChunkModulesAdvanced: new SyncBailHook(["chunks", "modules"], "compilation.optimizeChunkModulesAdvanced"),
			/** @type {SyncHook<Chunk[], Module[]>} */
			afterOptimizeChunkModules: new SyncHook(["chunks", "modules"], "compilation.afterOptimizeChunkModules"),
			/** @type {SyncBailHook} */
			shouldRecord: new SyncBailHook([], "compilation.shouldRecord"),

			/** @type {SyncHook<Module[], any>} */
			reviveModules: new SyncHook(["modules", "records"], "compilation.reviveModules"),
			/** @type {SyncHook<Module[]>} */
			optimizeModuleOrder: new SyncHook(["modules"], "compilation.optimizeModuleOrder"),
			/** @type {SyncHook<Module[]>} */
			advancedOptimizeModuleOrder: new SyncHook(["modules"], "compilation.advancedOptimizeModuleOrder"),
			/** @type {SyncHook<Module[]>} */
			beforeModuleIds: new SyncHook(["modules"], "compilation.beforeModuleIds"),
			/** @type {SyncHook<Module[]>} */
			moduleIds: new SyncHook(["modules"], "compilation.moduleIds"),
			/** @type {SyncHook<Module[]>} */
			optimizeModuleIds: new SyncHook(["modules"], "compilation.optimizeModuleIds"),
			/** @type {SyncHook<Module[]>} */
			afterOptimizeModuleIds: new SyncHook(["modules"], "compilation.afterOptimizeModuleIds"),

			/** @type {SyncHook<Chunk[], any>} */
			reviveChunks: new SyncHook(["chunks", "records"], "compilation.reviveChunks"),
			/** @type {SyncHook<Chunk[]>} */
			optimizeChunkOrder: new SyncHook(["chunks"], "compilation.optimizeChunkOrder"),
			/** @type {SyncHook<Chunk[]>} */
			beforeChunkIds: new SyncHook(["chunks"], "compilation.beforeChunkIds"),
			/** @type {SyncHook<Chunk[]>} */
			optimizeChunkIds: new SyncHook(["chunks"], "compilation.optimizeChunkIds"),
			/** @type {SyncHook<Chunk[]>} */
			afterOptimizeChunkIds: new SyncHook(["chunks"], "compilation.afterOptimizeChunkIds"),

			/** @type {SyncHook<Module[], any>} */
			recordModules: new SyncHook(["modules", "records"], "compilation.recordModules"),
			/** @type {SyncHook<Chunk[], any>} */
			recordChunks: new SyncHook(["chunks", "records"], "compilation.recordChunks"),

			/** @type {SyncHook} */
			beforeHash: new SyncHook([], "compilation.beforeHash"),
			/** @type {SyncHook<Chunk>} */
			contentHash: new SyncHook(["chunk"], "compilation.contentHash"),
			/** @type {SyncHook} */
			afterHash: new SyncHook([], "compilation.afterHash"),
			/** @type {SyncHook<any>} */
			recordHash: new SyncHook(["records"], "compilation.recordHash"),
			/** @type {SyncHook<Compilation, any>} */
			record: new SyncHook(["compilation", "records"], "compilation.record"),

			/** @type {SyncHook} */
			beforeModuleAssets: new SyncHook([], "compilation.beforeModuleAssets"),
			/** @type {SyncBailHook} */
			shouldGenerateChunkAssets: new SyncBailHook([], "compilation.shouldGenerateChunkAssets"),
			/** @type {SyncHook} */
			beforeChunkAssets: new SyncHook([], "compilation.beforeChunkAssets"),
			/** @type {SyncHook<Chunk[]>} */
			additionalChunkAssets: new SyncHook(["chunks"], "compilation.additionalChunkAssets"),

			/** @type {AsyncSeriesHook} */
			additionalAssets: new AsyncSeriesHook([], "compilation.additionalAssets"),
			/** @type {AsyncSeriesHook<Chunk[]>} */
			optimizeChunkAssets: new AsyncSeriesHook(["chunks"], "compilation.optimizeChunkAssets"),
			/** @type {SyncHook<Chunk[]>} */
			afterOptimizeChunkAssets: new SyncHook(["chunks"], "compilation.afterOptimizeChunkAssets"),
			/** @type {AsyncSeriesHook<CompilationAssets>} */
			optimizeAssets: new AsyncSeriesHook(["assets"], "compilation.optimizeAssets"),
			/** @type {SyncHook<CompilationAssets>} */
			afterOptimizeAssets: new SyncHook(["assets"], "compilation.afterOptimizeAssets"),

			/** @type {SyncBailHook} */
			needAdditionalSeal: new SyncBailHook([], "compilation.needAdditionalSeal"),
			/** @type {AsyncSeriesHook} */
			afterSeal: new AsyncSeriesHook([], "compilation.afterSeal"),

			/** @type {SyncHook<Chunk, Hash>} */
			chunkHash: new SyncHook(["chunk", "chunkHash"], "compilation.chunkHash"),
			/** @type {SyncHook<Module, string>} */
			moduleAsset: new SyncHook(["module", "filename"], "compilation.moduleAsset"),
			/** @type {SyncHook<Chunk, string>} */
			chunkAsset: new SyncHook(["chunk", "filename"], "compilation.chunkAsset"),

			/** @type {SyncWaterfallHook<string, TODO>} */
			assetPath: new SyncWaterfallHook(["filename", "data"], "compilation.assetPath"), // TODO MainTemplate

			/** @type {SyncBailHook} */
			needAdditionalPass: new SyncBailHook([], "compilation.needAdditionalPass"),
			...
			childCompiler: new SyncHook([
				...
				"compilerName",
				"compilerIndex"
			], "compilation.childCompiler"),

			/** @type {SyncBailHook<string, LogEntry>} */
			log: new SyncBailHook(["origin", "logEntry"], "compilation.log"),

			// TODO the following hooks are weirdly located here
			// TODO move them for webpack 5
			/** @type {SyncHook<object, Module>} */
			normalModuleLoader: new SyncHook(["loaderContext", "module"], "compilation.normalModuleLoader"),

			/** @type {SyncBailHook<Chunk[]>} */
			optimizeExtractedChunksBasic: new SyncBailHook(["chunks"], "compilation.optimizeExtractedChunksBasic"),
			/** @type {SyncBailHook<Chunk[]>} */
			optimizeExtractedChunks: new SyncBailHook(["chunks"], "compilation.optimizeExtractedChunks"),
			/** @type {SyncBailHook<Chunk[]>} */
			optimizeExtractedChunksAdvanced: new SyncBailHook(["chunks"], "compilation.optimizeExtractedChunksAdvanced"),
			/** @type {SyncHook<Chunk[]>} */
			afterOptimizeExtractedChunks: new SyncHook(["chunks"], "compilation.afterOptimizeExtractedChunks")
		};
	...
	getPathWithInfo(filename, data) {
		data = data || {};
		data.hash = data.hash || this.hash;
		data.entryPath = this._modules.entries().next().value[0].replace(/^multi /, '');
		data.context = this._modules.entries().next().value[1].context;
